...
public:
	...
	// 客户端过期时间秒
	static const long CLIENT_EXPIRE_TIME = 60 * 5;
	// TCP代理过期时间秒
	static const long TCP_PROXY_EXPIRE_TIME = 60 * 15;
	// UDP代理过期时间秒
	static const long UDP_PROXY_EXPIRE_TIME = 60 * 5;
	// TCP连接超时时间秒
	static const long TCP_CONNECT_TIMEOUT = 15;
	// Task 计时 
	static int TASK_TICK;
};
