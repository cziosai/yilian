...
public:
	...
	// TCP代理过期时间秒
	static const long TCP_PROXY_EXPIRE_TIME = 60 * 3;
	// UDP代理过期时间秒
	static const long UDP_PROXY_EXPIRE_TIME = 60 * 3;
	// TCP连接超时时间秒
	static const long TCP_CONNECT_TIMEOUT = 10;
	// Task 计时 
	static int TASK_ASLEEP;
};

// 服务器监听端口
int Config::PORT = 4430;
// 数据包最大值
int Config::MUTE = 1400;
// 用户名
