...
public:
	static const unsigned char TCP_HEADER_SIZE = 20;
	static const unsigned char FIN = 1;
	static const unsigned char SYN = 2;
	static const unsigned char RST = 4;
	static const unsigned char PSH = 8;
	static const unsigned char ACK = 16;
	static const unsigned char URG = 32;

	static const unsigned char offset_src_port = 0; // 16位源端口
	static const unsigned char offset_dest_port = 2; // 16位目的端口
	static const unsigned char offset_seq = 4; // 32位序列号
	static const unsigned char offset_ack = 8; // 32位确认号
	static const unsigned char offset_lenres = 12; // 4位首部长度 + 4位保留位
	static const unsigned char offset_flag = 13; // 2位保留字 + 6位标志位
	static const unsigned char offset_win = 14; //16位窗口大小
	static const unsigned char offset_crc = 16; // 16位校验和
	static const unsigned char offset_urp = 18; // 16位紧急偏移量
	...
	void setWindow(unsigned short value)
	{
	...
	void setUrp(unsigned short value)
	{
	...
	void setSeqID(unsigned int value)
	{
	...
	void setAckID(unsigned int value)
	{
	...
	bool ComputeTCPChecksum(IPHeader &ipHeader)
	{
		...
		unsigned long sum = ipHeader.getsum(ipHeader.mData, ipHeader.mOffset + IPHeader::offset_src_ip, 8);
		...
		unsigned short newCrc = ipHeader.checksum(sum, mData, mOffset, ipData_len);
