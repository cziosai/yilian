...
class UDPHeader
{
	 ...
	 **/
public:
	static const unsigned char UDP_HEADER_SIZE = 8;
	static const unsigned char offset_src_port = 0; // 源端口
	static const unsigned char offset_dest_port = 2; // 目的端口
	static const unsigned char offset_tlen = 4; // 数据报长度
	static const unsigned char offset_crc = 6; // 校验和
