...
public:
	...
	{
		unsigned char hlen = mData[mOffset + offset_ver_ihl] & 0x0F;
		mData[mOffset + offset_ver_ihl] = (unsigned char) ((ver << 4) | hlen);
	}
	...
	{
		unsigned char ver = mData[mOffset + offset_ver_ihl] & 0xF0;  // 保留高4位版本号
    	mData[mOffset + offset_ver_ihl] = (unsigned char)(ver | ((value + 3) / 4));
	}
